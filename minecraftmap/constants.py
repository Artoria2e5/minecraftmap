...
def multiplyColor(colorTuple, multiplier):
    ...
    return tuple([math.floor(a * multiplier / 255) for a in colorTuple])
...
allcolors = [multiplyColor(color, multiplier) for color in basecolors for multiplier in multipliers]
